...
/**
 * Public Clubdesk guides list API (PHP + PDO + Postgres/Neon).
...
try {
    ...
    if ($debug) {
        respond(500, ['error' => 'Failed to fetch guides', 'details' => $e->getMessage()]);
    }
    respond(500, ['error' => 'Failed to fetch guides']);
}
