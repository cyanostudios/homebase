...
describe('Cupappen cupDateFilters', () => {
  const now = new Date(2026, 7, 12, 15, 30, 0); // 12 Aug 2026 local
  ...
  it('upcoming uses end_date and keeps cups that end today', () => {
    expect(isUpcoming({ start_date: '2026-08-01', end_date: '2026-08-12' }, now)).toBe(true);
    expect(isUpcoming({ start_date: '2026-08-01', end_date: '2026-08-11' }, now)).toBe(false);
