...
| `.top-bar`        | Fullbredd i skalet; frosted `rgba(255,255,255,0.75)` + blur + `border-bottom` (inte beroende av `.glass`) |
| `.top-bar__inner` | Flex rad: logo + hamburger; padding `--page-pad`                                                          |
...
| Klass                                                           | Beskrivning                                                 |
| --------------------------------------------------------------- | ----------------------------------------------------------- |
| `.quick-nav` / `.quick-nav__badge`                              | Mobil: horisontell scroll + slutspacer; aktiv = brand-fylld |
