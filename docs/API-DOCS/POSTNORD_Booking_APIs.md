...
"$ref": "#/definitions/customsDeclarationId"
    ...
    "detailedDescriptionCustomsInvoice": {
      ...
      "properties": {
        ...
        "returnHsTariffNumber": {
          "$ref": "#/definitions/returnHsTariffNumber"
},
"hsTariffNumber": {
...
"$ref": "#/definitions/reasonForExportation"
    ...
    "returnHsTariffNumber": {
      "type": "string",
      "pattern": "^\\d{8}(\\d{2})?$",
"description": "A secondary HS tariff number to be used for returns-flow.",
"example": "33040000"
},
"hsTariffNumber": {
"type": "string",
...
"$ref": "#/definitions/parties"
        ...
        "goodsContentInfo": {
          "$ref": "#/definitions/goodsContentInfo"
},
"goodsItem": {
"type": "array",
"description": "Max 200 allowed",
...
"$ref": "#/definitions/content"
      ...
      "description": "Information about the content of the goods"
    },
    "goodsItem": {
      "type": "object",
      "required": [
