...
- **Files plugin:** [`FILES_PLUGIN.md`](FILES_PLUGIN.md) · ADR [`ai/adr/FILES_STORAGE_AND_URL_CONTRACT.md`](ai/adr/FILES_STORAGE_AND_URL_CONTRACT.md)
...
| Files (library + upload/attachments) | [`FILES_PLUGIN.md`](./FILES_PLUGIN.md), ADR [`ai/adr/FILES_STORAGE_AND_URL_CONTRACT.md`](./ai/adr/FILES_STORAGE_AND_URL_CONTRACT.md)                                                                                                                                                                 |
| Client optimistic UI guideline       | [`CLIENT_OPTIMISTIC_UI.md`](./CLIENT_OPTIMISTIC_UI.md)                                                                                                                                                                                                                                               |
...
- **Out of scope i docs (Homebase API-deploy):** `public-cups/` / cup-Railway — `CUPPAPPEN_PATHS_AND_STORAGE.md` + `CUPPAPPEN_RAILWAY_OPERATIONS.md`. **Nya** SEO-sajter: `PUBLIC_APP_TEMPLATE.md` + `templates/public-app/` (separat Railway-tjänst per app).
