...
| `mainImage`                                                                             | Nej                              | `null`                                                                                     |
| `images`                                                                                | Nej                              | `[]` (sparad asset-lista med metadata + `variants.original` / `preview` / `thumbnail`)     |
...
| `mainImage` / `images`                            | Nej i validator                  | `mainImage` är huvudbildens original-URL; `images` är sparade media-assets vars original-URL:er används i export                            |
