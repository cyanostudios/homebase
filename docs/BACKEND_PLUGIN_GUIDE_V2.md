# Backend Plugin Development Guide V2
Overview
Backend plugins provide database operations, API routes, and business logic using core services architecture. This guide reflects the modern abstraction-based approach with security enforcement at every layer.
Key Changes from V1:
...
2. Model Layer (Using Core Services)
