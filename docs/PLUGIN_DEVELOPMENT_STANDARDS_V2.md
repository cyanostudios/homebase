...
setValidationErrors(errors);
    ...
    try {
      ...
      if (currentMyPluginItem) {
        ...
        // ⚠️ IMPORTANT: Only set panelMode to 'view' if your plugin has a View component
        // in pluginRegistry.ts. If not, close the panel instead (see Common Mistakes section)
        setPanelMode('view'); // ✅ Safe here because this example plugin has a View component
      } else {
...
setPanelMode('view'); // ✅ Safe to use - View component will render
