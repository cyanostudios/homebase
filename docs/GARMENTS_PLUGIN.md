...
| Name _(required)_ | Jersey name · Initials · Number _(default on)_ | Team _(code, hidden)_ | Paid _(default on new lists)_ | _(custom person checkboxes)_ | _(per assigned article)_ Audience · Size · Ordered · Delivered · Handed out |
