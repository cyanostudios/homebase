...
| **Right sidebar**    | Desktop only (`AppRightSidebar`). Fixed ~48px rail with round tools: User / Pomodoro / Timer open slide-outs; Settings goes to `/settings`; on Teams (+ schedule enabled) a calendar tool toggles Schedule Companion Panel. Phone/pad: rail hidden; user menu in TopBar. Plugin detail sidebars stay inline.                                                                                                                                                                                                                                                                                                              |
