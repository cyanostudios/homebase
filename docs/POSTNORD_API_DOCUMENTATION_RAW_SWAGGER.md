  ...
  "paths": {
    ...
    "/v4/sac/pickup/stopdate": {
      "post": {
        ...
        "description": "* **Earliest Pickup Date** - The earliest date and time the goods is ready to be picked up at the sender.\n* **Next Pickup Stop Date Time** - The PostNord latest date time when the goods will be picked up at the sender.\n* **Next Booking Stop Date Time** - Shows the latest earliest pickup date to use, when PostNord guarantees the returned Next Pickup Stop Date Time.\n",
      ...
      "post": {
        ...
        "parameters": [
          ...
          },
          {
            "name": "fonts",
            "in": "query",
            "description": "The PostNord label uses the fonts Arial (E:ARI000.TTF, E:ARIAL.TTF, E:T0003M_). A client can override the font, but there are no guarantees that it works from a layout prespective.",
            "required": false,
            "type": "string",
