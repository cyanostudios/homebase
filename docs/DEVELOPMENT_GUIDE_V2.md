...
- **Pageviews (första-part):** `POST /api/pageview.php` + tenant-tabell via `npm run migrate:cups-pageviews`; admin **Statistik** i Cups (v1.5: period 7/30/90, tidsserie, bar-listor). ADR: [`ai/adr/CUPAPPEN_FIRST_PARTY_PAGEVIEWS.md`](ai/adr/CUPAPPEN_FIRST_PARTY_PAGEVIEWS.md). Changelog § **2026-08-13 – CupStats analytics dashboard (v1.5)** och § **2026-08-12 – Cupappen first-party pageviews**.
