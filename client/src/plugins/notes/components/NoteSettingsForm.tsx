import { Clock, Eye, History, LayoutGrid, List, Zap } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-[11px] text-gray-500 italic">
                How your notes are displayed by default
              </p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-[11px] text-gray-500">
                Display creation date and last updated info
              </p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <div className="flex items-center gap-2">
                ...
                <Badge
                  variant="outline"
                  className="bg-green-50/50 text-green-700 dark:text-green-300 border-green-100/50 font-medium text-[9px] h-4"
                >
                  Recommended
                </Badge>
              </div>
          ...
          <div className="flex items-center justify-between opacity-60">
            <div className="space-y-0.5">
              <div className="flex items-center gap-2">
                ...
                <Badge
                  variant="outline"
                  className="text-[9px] h-4 font-medium text-muted-foreground border-border/50 bg-secondary/30"
                >
                  Pro
                </Badge>
              </div>
              <p className="text-[11px] text-gray-500">
                Automatically suggest titles for your content
              </p>
            </div>
            <Switch disabled />
          </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <div className="text-[10px] text-gray-400 font-medium uppercase tracking-wider">
                  Recover notes from activity log
                </div>
              </div>
            </div>
            <Badge
              variant="outline"
              className="text-[10px] bg-secondary/50 text-secondary-foreground border-transparent font-medium"
            >
              5 Items
            </Badge>
          </Button>
