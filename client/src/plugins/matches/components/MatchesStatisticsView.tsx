...
export function MatchesStatisticsView({ inlineTrailing }: MatchesStatisticsViewProps = {}) {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-muted-foreground">{t('matches.statistics.description')}</p>
