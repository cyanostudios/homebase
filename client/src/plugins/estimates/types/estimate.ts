...
import { calculateInvoiceLineItem, type InvoiceLineItem } from '@/plugins/invoices/types/invoices';
...
export const ESTIMATE_STATUS_COLORS = {
  ...
  invoiced: QC_STATUS_BADGE_COLORS.purple,
} as const;
...
export function calculateLineItem(item: Partial<LineItem>): LineItem {
  return calculateInvoiceLineItem(item);
}
