                ...
                <div key={item.id} className="border-b border-gray-100 last:border-b-0 pb-4 last:pb-0">
                  ...
                  <div className="space-y-3 md:space-y-0 md:grid md:grid-cols-2 md:gap-3">
                    ...
                    <div>
                      ...
                      <div className="px-3 py-1.5 bg-gray-50 border border-gray-200 rounded-md text-base font-medium">
                  ...
                  <div className="mt-3 grid grid-cols-3 gap-4 text-sm text-gray-600">
                    <div>Subtotal: {item.lineSubtotal.toFixed(2)} {formData.currency}</div>
                    <div>VAT: {item.vatAmount.toFixed(2)} {formData.currency}</div>
                    <div>Total: {item.lineTotal.toFixed(2)} {formData.currency}</div>
                  </div>
                </div>
              ))}
            </div>
