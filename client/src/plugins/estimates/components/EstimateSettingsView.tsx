// Estimates settings as full-page content (like Core Settings / Notes): tab row + card + footer.
...
const estimateSettingsCategories = [{ id: 'view', label: 'View', icon: LayoutGrid }];
...
export function EstimateSettingsView() {
  ...
  const [selectedCategory, setSelectedCategory] = useState(estimateSettingsCategories[0].id);
  ...
  useEffect(() => {
    setHeaderTrailing(
      <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
        {estimateSettingsCategories.map((category) => {
