import { Edit, ExternalLink, Hash, Minus, Plus, ShoppingBag, Tag, X } from 'lucide-react';
    ...
    <div className="flex items-center gap-3">
      ...
      {!isFullView && onOpenFullProfile ? (
        <Button
          ...
          aria-label={t('garments.quickContext.openFullProfile')}
          title={t('garments.quickContext.openFullProfile')}
        />
      ) : null}
      <Button
        type="button"
      ...
      {!isFullView && onOpenFullProfile ? (
        <div className="border-t border-border/50 px-4 py-3">
          <Button
            ...
            onClick={onOpenFullProfile}
          >
            {t('garments.quickContext.openFullProfile')}
          </Button>
        </div>
      ) : null}
    </Card>
