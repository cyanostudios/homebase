...
export const IngestSourceForm: React.FC<IngestSourceFormProps> = ({
  currentIngest,
  onSave,
  onCancel,
  ...
  useEffect(() => {
    window.submitIngestForm = () => void handleSubmit();
    window.cancelIngestForm = () => handleCancel();
    return () => {
      delete window.submitIngestForm;
      delete window.cancelIngestForm;
    };
