...
export const FyndiqExportPanel: React.FC = () => {
  const { settings, openFyndiqSettingsPanel, openFyndiqSettingsForEdit } = useFyndiqProducts();
        ...
        <Card padding="lg" className="border-dashed">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="mt-4">
                <Button variant="default" onClick={() => openFyndiqSettingsPanel(null)}>
                  Connect
                </Button>
              </div>
            </div>
                    ...
                    <TableRow key={inst.id}>
                      <TableCell>
                        <div className="font-medium">
                          {inst.label || `fyndiq.${inst.instanceKey}`}
                        </div>
                      </TableCell>
                      <TableCell>
