...
export const PanelFooter: React.FC<PanelFooterProps> = ({
        ...
        <div className="flex items-center gap-3">
          {isInspection ? (
            <>
              ...
              <Button
                type="button"
                onClick={onSaveAndCloseClick ?? onSaveClick}
                variant="primary"
                icon={Check}
  ...
  return (
    <div className="flex justify-end space-x-3">
      ...
      >
        {isSubmitting ? (isInspection ? 'Sparar...' : 'Saving...') : isInspection ? 'Spara' : currentMode === 'edit' ? 'Update' : 'Save'}
      </Button>
    </div>
  );
};
...
export const createPanelFooter = (
  ...
  const handleSaveInView =
    pluginName === 'inspection' &&
    currentMode === 'view' &&
    typeof currentPluginContext?.saveInspectionAndClose === 'function'
      ? () => currentPluginContext.saveInspectionAndClose()
      : undefined;
  ...
  return (
    <PanelFooter
      ...
      onSaveAndCloseClick={handleSaveInView}
