#!/usr/bin/env node
// scripts/run-matches-contact-migration.js
// Run matches contact migration (031-matches-add-contact.sql) on all existing tenant databases
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/031-matches-add-contact.sql');
