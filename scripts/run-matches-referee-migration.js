#!/usr/bin/env node
// scripts/run-matches-referee-migration.js
// Run matches referee_count migration (042-matches-add-referee-count.sql) on all tenant databases
...
const MIGRATION_FILE = path.join(
  __dirname,
  '../server/migrations/042-matches-add-referee-count.sql',
);
