#!/usr/bin/env node
// scripts/run-requests-response-due-migration.js
// Run 135-requests-add-response-due-at.sql on all tenant databases.
...
const MIGRATION_FILE = path.join(
  __dirname,
  '../server/migrations/135-requests-add-response-due-at.sql',
);
