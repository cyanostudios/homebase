#!/usr/bin/env node
// scripts/run-invoices-recurring-payments-migration.js
// Run 157-invoices-recurring-payments.sql on all tenant databases.
...
const MIGRATION_FILE = path.join(
  __dirname,
  '../server/migrations/157-invoices-recurring-payments.sql',
);
