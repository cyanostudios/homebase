#!/usr/bin/env node
// scripts/run-matches-name-migration.js
// Run matches name migration (036-matches-add-name.sql) on all tenant databases
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/036-matches-add-name.sql');
