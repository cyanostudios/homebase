#!/usr/bin/env node
// scripts/run-schedule-user-id-migration.js
// Run 085-schedule-add-user-id.sql on all tenant databases
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/085-schedule-add-user-id.sql');
