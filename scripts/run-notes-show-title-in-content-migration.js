#!/usr/bin/env node
// scripts/run-notes-show-title-in-content-migration.js
// Run 126-notes-show-title-in-content.sql on all tenant databases
...
const MIGRATION_FILE = path.join(
  __dirname,
  '../server/migrations/126-notes-show-title-in-content.sql',
);
