#!/usr/bin/env node
// scripts/run-cups-pageviews-migration.js
// Run server/migrations/129-cupappen-pageviews-daily.sql on all tenant databases.
...
const MIGRATION_FILE = path.join(
  __dirname,
  '../server/migrations/129-cupappen-pageviews-daily.sql',
);
