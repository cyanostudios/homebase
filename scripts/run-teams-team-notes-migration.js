#!/usr/bin/env node
// scripts/run-teams-team-notes-migration.js
// Run teams team_notes migration (078-teams-team-notes.sql) on all existing tenant databases
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/078-teams-team-notes.sql');
