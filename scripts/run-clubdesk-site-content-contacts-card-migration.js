#!/usr/bin/env node
// scripts/run-clubdesk-site-content-contacts-card-migration.js
// Run server/migrations/161-clubdesk-site-content-contacts-card.sql on all tenant databases.
...
const MIGRATION_FILE = path.join(
  __dirname,
  '../server/migrations/161-clubdesk-site-content-contacts-card.sql',
);
...
async function main() {
  ...
  try {
    ...
    console.log(
      `Applying 161-clubdesk-site-content-contacts-card.sql to ${tenants.length} tenant(s)...`,
    );
