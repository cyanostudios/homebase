#!/usr/bin/env node
// scripts/run-invoices-status-partially-paid-migration.js
// Run 159-invoices-status-partially-paid.sql on all tenant databases.
...
const MIGRATION_FILE = path.join(
  __dirname,
  '../server/migrations/159-invoices-status-partially-paid.sql',
);
