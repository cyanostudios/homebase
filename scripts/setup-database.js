  ...
  try {
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS estimates (
        ...
        status VARCHAR(20) DEFAULT 'draft' CHECK (status IN ('draft', 'sent', 'accepted', 'rejected', 'invoiced')),
    ...
    `);
    await client.query('CREATE INDEX IF NOT EXISTS idx_task_shares_task ON task_shares(task_id)');
    await client.query(
