#!/usr/bin/env node
// scripts/run-cups-sync-state-migration.js
// Run server/migrations/070-cups-sync-state.sql on all tenant databases.
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/070-cups-sync-state.sql');
