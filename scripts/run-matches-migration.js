#!/usr/bin/env node
// scripts/run-matches-migration.js
// Run matches migration (028-matches.sql) on all existing tenant databases
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/028-matches.sql');
