#!/usr/bin/env node
// scripts/run-teams-playing-format-migration.js
// Run playing_format migration (110-teams-add-playing-format.sql) on all existing tenant databases
...
const MIGRATION_FILE = path.join(
  __dirname,
  '../server/migrations/110-teams-add-playing-format.sql',
);
