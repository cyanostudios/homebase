#!/usr/bin/env node
// scripts/run-invoices-paid-at-migration.js
// Run 147-invoices-add-paid-at.sql on all tenant databases.
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/147-invoices-add-paid-at.sql');
