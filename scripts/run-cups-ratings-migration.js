#!/usr/bin/env node
// scripts/run-cups-ratings-migration.js
// Run server/migrations/073-cup-ratings.sql on all tenant databases.
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/073-cup-ratings.sql');
