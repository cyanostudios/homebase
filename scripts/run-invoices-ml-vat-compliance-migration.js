#!/usr/bin/env node
// scripts/run-invoices-ml-vat-compliance-migration.js
// Run 164-invoices-ml-vat-compliance.sql on all tenant databases.
...
const MIGRATION_FILE = path.join(
  __dirname,
  '../server/migrations/164-invoices-ml-vat-compliance.sql',
);
