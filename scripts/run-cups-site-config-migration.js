#!/usr/bin/env node
// scripts/run-cups-site-config-migration.js
// Run server/migrations/130-cups-site-config.sql on all tenant databases.
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/130-cups-site-config.sql');
