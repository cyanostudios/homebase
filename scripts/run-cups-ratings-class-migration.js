#!/usr/bin/env node
// scripts/run-cups-ratings-class-migration.js
// Run server/migrations/075-cup-ratings-add-reviewer-class.sql on all tenant databases.
...
const MIGRATION_FILE = path.join(
  __dirname,
  '../server/migrations/075-cup-ratings-add-reviewer-class.sql',
);
