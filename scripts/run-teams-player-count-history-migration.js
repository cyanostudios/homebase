#!/usr/bin/env node
// scripts/run-teams-player-count-history-migration.js
// Run player_count_history migration (146) on all existing tenant databases.
// Uses DATABASE_URL (main) + TENANT_PROVIDER like other teams migrate:* scripts.
// Prod Railway deploy of this SQL still requires explicit release.
...
const MIGRATION_FILE = path.join(
  __dirname,
  '../server/migrations/146-teams-player-count-history.sql',
);
