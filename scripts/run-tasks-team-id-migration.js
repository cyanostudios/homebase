#!/usr/bin/env node
// scripts/run-tasks-team-id-migration.js
// Run 118-tasks-add-team-id.sql on all tenant databases
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/118-tasks-add-team-id.sql');
