#!/usr/bin/env node
// scripts/run-schedule-event-team-id-migration.js
// Run 086-schedule-event-team-id.sql on all tenant databases
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/086-schedule-event-team-id.sql');
