#!/usr/bin/env node
// scripts/run-slot-bookings-migration.js
// Run migration 036 (slot_bookings and notifications tables) on all existing tenant databases
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/036-slot-bookings.sql');
