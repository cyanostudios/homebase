#!/usr/bin/env node
// scripts/run-cups-featured-image-drive-url-migration.js
// Run server/migrations/072-cups-featured-image-drive-url.sql on all tenant databases.
...
const MIGRATION_FILE = path.join(
  __dirname,
  '../server/migrations/072-cups-featured-image-drive-url.sql',
);
