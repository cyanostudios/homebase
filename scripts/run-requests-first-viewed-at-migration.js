#!/usr/bin/env node
// scripts/run-requests-first-viewed-at-migration.js
// Run 145-requests-add-first-viewed-at.sql on all tenant databases.
...
const MIGRATION_FILE = path.join(
  __dirname,
  '../server/migrations/145-requests-add-first-viewed-at.sql',
);
