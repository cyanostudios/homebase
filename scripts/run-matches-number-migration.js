#!/usr/bin/env node
// scripts/run-matches-number-migration.js
// Run matches match_number migration (040-matches-add-match-number.sql) on all tenant databases
...
const MIGRATION_FILE = path.join(
  __dirname,
  '../server/migrations/040-matches-add-match-number.sql',
);
