#!/usr/bin/env node
// scripts/run-invoices-align-schema-migration.js
// Run 148-invoices-align-schema.sql on all tenant databases.
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/148-invoices-align-schema.sql');
