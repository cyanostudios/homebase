#!/usr/bin/env node
// scripts/run-schedule-counts-toward-capacity-migration.js
// Run counts_toward_capacity migration (111-schedule-counts-toward-capacity.sql) on all existing tenant databases
...
const MIGRATION_FILE = path.join(
  __dirname,
  '../server/migrations/111-schedule-counts-toward-capacity.sql',
);
