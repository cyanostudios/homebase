#!/usr/bin/env node
// scripts/run-teams-migration.js
// Run teams migration (076-teams.sql) on all existing tenant databases
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/076-teams.sql');
