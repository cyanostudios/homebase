#!/usr/bin/env node
// scripts/run-teams-series-teams-migration.js
// Run series_teams migration (079-teams-series-teams.sql) on all existing tenant databases
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/079-teams-series-teams.sql');
