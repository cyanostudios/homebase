#!/usr/bin/env node
// scripts/run-invoices-recurring-payments-user-id-migration.js
// Run 158-invoices-recurring-payments-user-id.sql on all tenant databases.
...
const MIGRATION_FILE = path.join(
  __dirname,
  '../server/migrations/158-invoices-recurring-payments-user-id.sql',
);
