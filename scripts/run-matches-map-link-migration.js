#!/usr/bin/env node
// scripts/run-matches-map-link-migration.js
// Run matches map_link migration (043-matches-add-map-link.sql) on all tenant databases
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/043-matches-add-map-link.sql');
