#!/usr/bin/env node
// scripts/run-mail-migration.js
// Run Mail plugin migrations (log + settings + provider platform) on all tenant databases
...
const MIGRATION_FILES = [
  path.join(__dirname, '../server/migrations/023-mail-log.sql'),
  path.join(__dirname, '../server/migrations/025-mail-settings.sql'),
  path.join(__dirname, '../server/migrations/026-mail-settings-resend.sql'),
  path.join(__dirname, '../server/migrations/125-mail-provider-platform.sql'),
];
