#!/usr/bin/env node
// scripts/run-requests-plugin-routing-migration.js
// Run 144-requests-plugin-routing.sql on all tenant databases.
...
const MIGRATION_FILE = path.join(__dirname, '../server/migrations/144-requests-plugin-routing.sql');
