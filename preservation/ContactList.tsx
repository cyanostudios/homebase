...
import { ChevronUp, ChevronDown, Eye, Plus, ChevronLeft, ChevronRight } from "lucide-react";
...
function ContactRow({ contact, onClick }: ContactRowProps) {
  const contactPersons: Array<{ firstName: string; lastName: string; title: string; directPhone?: string; mobile?: string; email?: string; }> = contact.contactPersons || [];
  ...
  return (
    ...
    >
      ...
      <td className="px-4 py-3 text-center">
        <Button className="inline-flex items-center px-4 py-2 bg-blue-600/20 hover:bg-blue-600/30 text-blue-600 text-sm font-medium rounded-md transition-colors">
