...
function createCdonProductsRoutes(controller, context) {
  ...
  router.post('/statuses/batch', gate, csrfProtection, (req, res) => controller.statusesBatch(req, res));
  router.post('/statuses/sku', gate, csrfProtection, (req, res) => controller.statusesSku(req, res));
